...
$lastDate="SELECT * FROM `jos_demiejournees` ORDER BY 'date'";
echo $lastDate;
...
$vide=mysql_query("TRUNCATE TABLE `jos_demiejournees`");
if(!$vide) {
	echo "Error on sql query: TRUNCATE TABLE `jos_demiejournees` <br>" .mysql_error();
	}
*/
	$i=0;
while($i<270){
